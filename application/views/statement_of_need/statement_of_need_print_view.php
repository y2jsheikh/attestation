                ...
                <div style="padding-top: 150px; padding-left: 30px; padding-right: 30px;">
                    <div class="row">
                        ...
                        <div style="float: right; width: 50%;">
                            ...
                            <h5 class="pull-right"><strong class="pull-right">Serial Number: 20/<?php echo date('Y'); ?></strong><br/><strong>Islamabad, <?php echo date('F d, Y', time()); ?></strong></h5>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="mt-2 col-md-12">
                        ...
                        ?>
                        <h4 class="text-center"><strong><u><?php echo strtoupper($heading) ?></u></strong></h4><br/><br/>

                        <div class="col-md-12">
                            <p>
                                <b>USMLE/ECFMG ID Number: <?php echo $result->ecfmg_no ?></b>
                                <br/>
                                <b>Name of Applicant for Visa: <?php echo $result->fullname ?></b>
                                <br/>

                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-success" id="btn-excel"><i class="fa fa-file-excel-o"></i> Export</button>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#btn-excel").click(function () {
            $("#my_data").table2excel({
                exclude: ".noExl",
                name: "Courier Report",
                filename: "courier_report"
            });

            /*
            $(".table-data-new").tableHTMLExport({
                // csv, txt, json, pdf
                type:'csv',
                // default file name
    ...
    function show_ajax_cards(obj) {
        ...
        var post_data = {
            ...
            'action': "courier_sent_report_content"
        };

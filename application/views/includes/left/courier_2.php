...
<a href="<?php echo site_url('courier/centers/mnp') ?>" class="list-group-item-action-main"><i class="fa fa-building" aria-hidden="true"></i> Courier Centers</a>
<a href="<?php echo site_url('report/courier_sent/5') ?>" class="list-group-item-action-main"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Report</a>

...
<div class="row" style="margin-top: -2%;" id="dashboard_print">
    <div class="col-md-3 col-sm-12">
        ...
        <div class="dashboard-dashboardboxes-main">
            <div class="dashboard-dashboardboxes dashboard-dashboardboxes-transparent">
                ...
                <!--<div class="no-of-transdashboard"><a href="<?php /*echo site_url('attestation/dispatch') */?>"><small class="text-info"> &nbsp; &nbsp; &nbsp; &nbsp; To be Dispatched : <?php /*echo $ministry_to_be_dispatched_application_count */?></small></a></div>-->
                <div class="no-of-transdashboard"><small class="text-warning"> &nbsp; &nbsp; Pending : <?php echo $pending_application_count ?></small></div>
                <!--<div class="no-of-transdashboard"><a href="javascript:void(0)"><small class="text-danger"> &nbsp; &nbsp; Not Received : <?php /*echo $not_received_count */?></small></a></div>-->
            </div>
        </div>
        <div class="dashboard-dashboardboxes-main">
            <div class="dashboard-dashboardboxes dashboard-dashboardboxes-transparent">
    ...
    <div class="col-md-3 col-sm-12">
        <div class="dashboard-dashboardboxes-main">
            <!--<h4 class="text-center">Courier Companies</h4>-->
            <div class="dashboard-dashboardboxes dashboard-dashboardboxes-transparent">
                <div class="no-of-transdashboard">TCS</div>
                <!--<div class="no-of-transdashboard"><small class="text-warning">Not Received : <?php /*echo $tcs_not_submitted_application_count */?></small></div>-->
                <div class="no-of-transdashboard"><small class="text-info">Received : <?php echo $tcs_application_count ?></small></div>
        ...
        <div class="dashboard-dashboardboxes-main">
            <div class="dashboard-dashboardboxes dashboard-dashboardboxes-transparent">
                <div class="no-of-transdashboard">M&P</div>
                <!--<div class="no-of-transdashboard"><small class="text-warning">Not Received : <?php /*echo $mnp_not_submitted_application_count */?></small></div>-->
                <div class="no-of-transdashboard"><small class="text-info">Received : <?php echo $mnp_application_count ?></small></div>

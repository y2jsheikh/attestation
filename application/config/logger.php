 ...
 * By default library storing logs in "transaction_log" table if you want to save logs in same table you
 can leave blank "table_name" 

 * This is sql for "transaction_log" table
 *
 *
...
$config['session_user_id'] = 'id'; // You can tell the library to take the user id from a session variable
$config['table_name'] = ''; // If you prefer to name the table other than "transaction_log" you can set it here...
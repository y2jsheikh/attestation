!function (h) {
        ...
        try {
            ...
            try {
                for (var a = o.querySelectorAll("canvas"), i = 0; i < a.length; i++) {
                    var l = a[i].getContext("2d"), c = new Image;
                    c.onload = function () {
                        l.drawImage(c, 0, 0)
    ...
    h.print = h.fn.print = function () {
        ...
        var o = s(o, !0, !0);
        (o = h("<span/>").append(o)).find(t.noPrintSelector).remove(), o.append(s(n)), t.title && (0 === (d = h("title", o)).length && (d = h("<title />"), o.append(d)), d.text(t.title)), o.append(f(t.append)), o.prepend(f(t.prepend)), t.manuallyCopyFormValues && (o.find("input").each(function () {
            var e = h(this);
        ...
        var a, i, l, c, d = o.html();
        try {
            t.deferred.notify("generated_markup", d, o)
        } catch (e) {
            console.warn("Error notifying deferred", e)
        }
        if (o.remove(), t.iframe) try {
            a = d, l = h((i = t).iframe + ""), c = l.length, p((l = 0 === c ? h('<iframe height="0" width="0" border="0" wmode="Opaque"/>').prependTo("body").css({
                position: "absolute",
                top: -999,
                left: -999
            }) : l).get(0), a, i).done(function () {
                setTimeout(function () {
                    0 === c && l.remove()
                }, 1e3)
            }).fail(function (e) {
